...
<nav class="navbar navbar-expand-lg fixed-top" style="font-family: poppins, sans-serif;">
  ...
  <!-- Upload Button -->
  <button class="upload-btn" id="uploadBtn" onclick="window.location.href='form unggah resep.html'">Unggah Resepmu</button>
    ...
    <div class="row">
      ...
      <div class="recipe-card">
        ...
        <div class="info">
          <div class="tags">
            <span class="tag"><img src="foto/clock.png" id="tageasy" alt="">1 jam</span>
            <span class="tag easy"><img src="foto/cook.png" id="tageasy" alt="">4 porsi</span>
          </div>
